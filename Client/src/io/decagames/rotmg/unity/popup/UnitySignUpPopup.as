...
package io.decagames.rotmg.unity.popup{
    ...
    public class UnitySignUpPopup extends ModalPopup {
        ...
        private function createButtons():void{
            ...
            _local1 = this.createButtonDecoration();
            _local1.y = -3;
            this._buttonContainer.addChild(_local1);
            ...
            var _local2:SliceScalingBitmap = this.createButtonDecoration();
            _local2.x = ((_local1.x + _local1.width) + this.MARGIN);
            _local2.y = _local1.y;
            this._buttonContainer.addChild(_local2);
            ...
            this._submitButton.x = (_local2.x + 19);
        ...
        private function createButtonDecoration():SliceScalingBitmap{
            var _local1:SliceScalingBitmap = new TextureParser().getSliceScalingBitmap("UI", "main_button_decoration", 186);
            _local1.scaleX = 0.9;
            _local1.scaleY = 0.9;
            return (_local1);
        }
        ...
        private function createContentInset():void{
            var _local1:SliceScalingBitmap = TextureParser.instance.getSliceScalingBitmap("UI", "popup_content_inset", this.WIDTH);
            _local1.height = (this.HEIGHT - 50);
            addChild(_local1);
        }
