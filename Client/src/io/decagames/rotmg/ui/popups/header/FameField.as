...
package io.decagames.rotmg.ui.popups.header{
    ...
    public class FameField extends Sprite {
        ...
        public function FameField(_arg1:int){
            this.fameFieldBackground = TextureParser.instance.getSliceScalingBitmap("UI", "bordered_field", _arg1);
            ...
            this.fameBitmap.y = -4;
            this.fameBitmap.x = (_arg1 - 40);
            addChild(this.fameBitmap);
        }

        public function set fameAmount(_arg1:int):void{
