...
package io.decagames.rotmg.dailyQuests.view{
    ...
    public class DailyQuestWindow extends UIPopup {
        ...
        public function setCompletedCounter(_arg1:int, _arg2:int):void{
            if (_arg1 == _arg2){
        ...
        public function setQuestRefreshHeader(_arg1:String):void{
            this.questRefreshText.text = _arg1;
        }
        ...
        public function showFade(_arg1:int=0x151515, _arg2:Boolean=false):void{
            if (_arg2){
