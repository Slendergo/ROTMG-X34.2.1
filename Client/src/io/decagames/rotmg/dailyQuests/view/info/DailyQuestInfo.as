...
package io.decagames.rotmg.dailyQuests.view.info{
    ...
    public class DailyQuestInfo extends Sprite {
        ...
        public static function hasAllItems(_arg1:Vector.<int>, _arg2:Vector.<int>):Boolean{
            var _local4:int;
            var _local5:int;
            var _local3:Vector.<int> = _arg1.concat();
        ...
        public function dailyQuestsCompleted():void{
            var _local1:DailyQuestItemSlot;
        ...
        private function showQuestsCompleteInfo(_arg1:Boolean, _arg2:Boolean=true):void{
            this.questAvailable.visible = _arg1;
            this.refreshInfo.visible = _arg1;
            this.rewardsChoice.visible = ((_arg2) ? !(_arg1) : _arg1);
            this.rewardsTitle.visible = ((_arg2) ? !(_arg1) : _arg1);
            this.contentDivider.visible = ((_arg2) ? !(_arg1) : _arg1);
            this.contentDividerTitle.visible = ((_arg2) ? !(_arg1) : _arg1);
            this._completeButton.visible = ((_arg2) ? !(_arg1) : _arg1);
        }

        public function show(_arg1:DailyQuest, _arg2:Vector.<int>):void{
            this._playerEquipment = _arg2.concat();
            this.showQuestsCompleteInfo(false);
            this.rewardsChoice.visible = _arg1.itemOfChoice;
            this.questName.text = _arg1.name;
            this.questDescription.text = _arg1.description;
            SlotsRendered.renderSlots(_arg1.requirements, this._playerEquipment, DailyQuestItemSlotType.REQUIREMENT, this.requirementsContainer, this.requirementsTopMargin, this.slotMargin, INFO_WIDTH, this.slots);
            SlotsRendered.renderSlots(_arg1.rewards, this._playerEquipment, DailyQuestItemSlotType.REWARD, this.rewardsContainer, this.rewardsTopMargin, this.slotMargin, INFO_WIDTH, this.slots, _arg1.itemOfChoice);
            this._completeButton.disabled = ((_arg1.completed) ? true : !(hasAllItems(_arg1.requirements, _arg2)));
            this._completeButton.completed = _arg1.completed;
        ...
        public function setQuestAvailableTime(_arg1:String):void{
            this.questAvailable.text = _arg1;
