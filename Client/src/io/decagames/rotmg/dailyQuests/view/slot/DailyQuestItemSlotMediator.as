...
package io.decagames.rotmg.dailyQuests.view.slot{
    ...
    public class DailyQuestItemSlotMediator extends Mediator {
        ...
        override public function initialize():void{
            ...
            this.tooltip = new EquipmentToolTip(this.view.itemID, (((this.view.type == DailyQuestItemSlotType.REQUIREMENT)) ? null : _local1), _local2, InventoryOwnerTypes.CURRENT_PLAYER);
        ...
        private function unselectHandler(_arg1:int):void{
            if (this.view.itemID != _arg1){
        ...
        private function onSlotSelected(_arg1:MouseEvent):void{
