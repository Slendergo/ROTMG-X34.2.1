...
package io.decagames.rotmg.dailyQuests.view{
    ...
    public class DailyQuestWindowMediator extends Mediator {
        ...
        private function setRefreshButtonState(_arg1:Boolean):void{
            this.view.refreshButton.disabled = _arg1;
        }
        ...
        private function onTabSelected(_arg1:String):void{
            if (_arg1 == DailyQuestsList.EVENT_TAB_LABEL){
        ...
        private function setToolTipTitle(_arg1:String, _arg2:String):void{
            this.toolTip = new TextToolTip(0x363636, 0x9B9B9B, _arg1, _arg2, 300, null);
        ...
        private function updateTimeHandler(_arg1:Event):void{
            var _local2:String = ("Quests refresh in " + this.dailyLoginModel.getFormatedQuestRefreshTime());
            this.view.setQuestRefreshHeader(_local2);
        }
        ...
        private function buyRefreshToolTip():IconToolTip{
            var _local1:String = ("Refresh your Daily Quests for " + this.dailyQuestsModel.nextRefreshPrice);
            var _local2:IconToolTip = new IconToolTip("Refresh Daily Quests", _local1, 0x363636, 1, 0x9B9B9B, 1, true, new Bitmap(IconFactory.makeCoin()));
            return (_local2);
        }
        ...
        private function createBuyQuestRefreshToolTip(_arg1:IconToolTip):void{
            ...
            this.refreshTooltipDelegate.tooltip = _arg1;
        }

        private function onRedeemComplete(_arg1:QuestRedeemResponse):void{
            var questId:String;
            var completedQuests:int;
            var message:QuestRedeemResponse = _arg1;
            try {
                if (message.ok){
        ...
        private function hasEnoughGold(_arg1:int):Boolean{
            return ((_arg1 <= this.hudModel.gameSprite.map.player_.credits_));
        }
