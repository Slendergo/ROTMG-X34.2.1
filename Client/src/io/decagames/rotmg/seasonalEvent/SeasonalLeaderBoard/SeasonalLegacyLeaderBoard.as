...
package io.decagames.rotmg.seasonalEvent.SeasonalLeaderBoard{
    ...
    public class SeasonalLegacyLeaderBoard extends UIPopup {
        ...
        public function addTop20Item(_arg1:SeasonalLeaderBoardItemData):void{
            var _local2:SeasonalLeaderBoardItem = new SeasonalLeaderBoardItem(_arg1);
            var _local3:UIGridElement = new UIGridElement();
            _local3.addChild(_local2);
            this._top20Grid.addGridElement(_local3);
        }

        public function addPlayerListItem(_arg1:SeasonalLeaderBoardItemData):void{
            var _local2:SeasonalLeaderBoardItem = new SeasonalLeaderBoardItem(_arg1);
            var _local3:UIGridElement = new UIGridElement();
            _local3.addChild(_local2);
        ...
        public function setErrorMessage(_arg1:String):void{
            this._error.text = _arg1;
            this._error.y = ((this.height - this._error.height) / 2);
            this._error.visible = true;
        }

        public function setDropDownData(_arg1:Vector.<String>):void{
            this._seasons = _arg1;
            this.createDropDown();
        }
        ...
        private function createTab(_arg1:String, _arg2:Sprite, _arg3:UIGrid):UITab{
            var _local5:int;
            var _local4:UITab = new UITab(_arg1, true);
            this._tabContent = new Sprite();
            _arg2.x = this._contentInset.x;
            this._tabContent.addChild(_arg2);
            _arg2.y = 16;
            _arg2.addChild(_arg3);
            _local5 = 370;
            var _local6:UIScrollbar = new UIScrollbar(_local5);
            _local6.mouseRollSpeedFactor = 1;
            _local6.scrollObject = _local4;
            _local6.content = _arg2;
            _local6.x = (WIDTH - 46);
            _local6.y = 16;
            this._tabContent.addChild(_local6);
            var _local7:Sprite = new Sprite();
            _local7.graphics.beginFill(0);
            _local7.graphics.drawRect(0, 0, WIDTH, _local5);
            _local7.x = _arg2.x;
            _local7.y = _arg2.y;
            _arg2.mask = _local7;
