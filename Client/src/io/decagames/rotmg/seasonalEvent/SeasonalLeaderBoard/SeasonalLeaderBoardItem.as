...
package io.decagames.rotmg.seasonalEvent.SeasonalLeaderBoard{
    ...
    public class SeasonalLeaderBoardItem extends Sprite {
        ...
        public function SeasonalLeaderBoardItem(_arg1:SeasonalLeaderBoardItemData){
            this._seasonalLeaderBoardItemData = _arg1;
            this.init();
        }
        ...
        private function createFameIcon():void{
            ...
            this.fameIcon = new Bitmap(TextureRedrawer.redraw(_local1, 30, true, 0));
