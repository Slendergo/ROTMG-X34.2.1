...
package io.decagames.rotmg.seasonalEvent.SeasonalLeaderBoard{
    ...
    public class SeasonalLeaderBoardMediator extends Mediator {
        ...
        private function setGeneratedTime():void{
            var _local1:Date = (((this.view.tabs.currentTabLabel == SeasonalLeaderBoard.TOP_20_TAB_LABEL)) ? this.seasonalEventModel.leaderboardTop20CreateTime : this.seasonalEventModel.leaderboardPlayerCreateTime);
        ...
        private function updateRefreshTime():void{
            ...
            this.view.refreshTime.text = (REFRESH_TIME + _local1);
        }

        private function getTimeFormat(_arg1:Number):String{
            var _local2:Date = new Date(_arg1);
            var _local3:String = (((_local2.getUTCHours() > 9)) ? _local2.getUTCHours().toString() : ("0" + _local2.getUTCHours()));
            var _local4:String = (((_local2.getUTCMinutes() > 9)) ? _local2.getUTCMinutes().toString() : ("0" + _local2.getUTCMinutes()));
            var _local5:String = (((_local2.getUTCSeconds() > 9)) ? _local2.getUTCSeconds().toString() : ("0" + _local2.getUTCSeconds()));
        ...
        private function onTabSelected(_arg1:String):void{
            ...
            this.showSpinner();
            if (this.timeToRefresh() <= 0){
                this.requestChallengerListSignal.dispatch(this.legendsModel.getTimespan(), _arg1);
            }
            else {
                if (_arg1 == SeasonalLeaderBoard.TOP_20_TAB_LABEL){
                    this.upDateTop20();
                }
                else {
                    if (_arg1 == SeasonalLeaderBoard.PLAYER_TAB_LABEL){
        ...
        private function timeToRefresh():Number{
            var _local2:Date;
            var _local1:Date = (((this.view.tabs.currentTabLabel == SeasonalLeaderBoard.TOP_20_TAB_LABEL)) ? this.seasonalEventModel.leaderboardTop20RefreshTime : this.seasonalEventModel.leaderboardPlayerRefreshTime);
            if (_local1){
                _local2 = new Date();
