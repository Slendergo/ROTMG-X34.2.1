...
package io.decagames.rotmg.pets.popup.hatching{
    ...
    public class PetHatchingDialog extends ModalPopup {
        ...
        public function PetHatchingDialog(_arg1:String, _arg2:int, _arg3:int, _arg4:Boolean, _arg5:SkinVO){
            var petName:String = _arg1;
            var petSkin:int = _arg2;
            var itemType:int = _arg3;
            var unlocked:Boolean = _arg4;
            var skinVO:SkinVO = _arg5;
        ...
        private function getTypeBitmap():Bitmap{
            var _local1:String = ObjectLibrary.getIdFromType(this._petSkin);
            ...
            var _local7:BitmapData = TextureRedrawer.resize(_local6.image_, _local6.mask_, this.eggSize, true, 0, 0);
        ...
        private function animateEgg(_arg1:TimelineMax, _arg2:Bitmap, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Function=null):void{
            _arg1.to(_arg2, _arg4, {
                delay:_arg5,
                transformAroundPoint:{
                    point:new Point((_arg2.width / 2), _arg2.height),
                    pointIsLocal:true,
                    rotation:_arg3
                },
                onComplete:_arg6,
