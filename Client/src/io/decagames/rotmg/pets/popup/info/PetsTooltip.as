...
package io.decagames.rotmg.pets.popup.info{
    ...
    public class PetsTooltip extends ToolTip {
        ...
        private function createTable():void{
            ...
            DefaultLabelFormat.infoTooltipText(_local1, 6539085);
            this.tableContainer.addChild(_local1);
            _local1.text = "1st Ability";
            _local1.x = 80;
            _local1.y = 0;
            ...
            _local4.x = 80;
            _local4.y = ((_local3.y + _local3.height) - 4);
            var _local5:UILabel = new UILabel();
            DefaultLabelFormat.infoTooltipText(_local5, 5082311);
            this.tableContainer.addChild(_local5);
            _local5.text = "Evolution";
            _local5.x = 80;
            _local5.y = ((_local4.y + _local4.height) - 4);
