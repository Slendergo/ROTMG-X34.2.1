...
package io.decagames.rotmg.pets.windows.yard.feed{
    ...
    public class FeedTab extends UITab {
        ...
        public function FeedTab(_arg1:int){
            ...
            _local2 = ((_arg1 - ((this._feedGoldButton.width + this._feedFameButton.width) + this.feedButtonsMargin)) / 2);
            this._feedGoldButton.x = _local2;
            this._feedFameButton.x = ((this._feedGoldButton.x + this._feedGoldButton.width) + _local2);
            addChild(this._feedGoldButton);
            addChild(this._feedFameButton);
        }

        public function updateFeedPower(_arg1:int, _arg2:Boolean):void{
            if ((((_arg1 == 0)) || (_arg2))){
                this.feedLabel.text = ((_arg2) ? "Fully Maxed" : "Select Items to Feed");
                this._feedGoldButton.alpha = 0;
                this._feedFameButton.alpha = 0;
            }
            else {
                this.feedLabel.text = ("Feed power: " + _arg1);
                this._feedGoldButton.alpha = 1;
                this._feedFameButton.alpha = 1;
            };
            this._feedGoldButton.disabled = (_arg1 == 0);
            this._feedFameButton.disabled = (_arg1 == 0);
        }
        ...
        public function addItem(_arg1:FeedItem):void{
            this.feedGrid.addGridElement(_arg1);
        }
