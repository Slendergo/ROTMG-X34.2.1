...
package io.decagames.rotmg.pets.components.caretaker{
    ...
    public class CaretakerQueryDialog extends Sprite {
        ...
        public const closed:Signal = new org.osflash.signals.natives.NativeMappedSignal(closeButton, flash.events.MouseEvent.CLICK);
        ...
        private function makeCategoryList():CaretakerQueryDialogCategoryList{
            var _local1:CaretakerQueryDialogCategoryList;
            _local1 = new CaretakerQueryDialogCategoryList(CATEGORIES);
            _local1.x = 20;
            _local1.y = 110;
