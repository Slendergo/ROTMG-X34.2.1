...
package io.decagames.rotmg.pets.components.tooltip{
    ...
    public class PetTooltip extends ToolTip {
        ...
        public function PetTooltip(_arg1:IPetVO){
            this.petVO = _arg1;
        ...
        private function makeProbabilityTipLine(_arg1:String, _arg2:uint):String{
            return ((("Can " + TooltipHelper.wrapInFontTag(_arg1, ("#" + _arg2.toString(16)))) + " be obtained\nthrough hatching or fusion."));
        }
