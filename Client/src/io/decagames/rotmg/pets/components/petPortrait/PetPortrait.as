...
package io.decagames.rotmg.pets.components.petPortrait{
    ...
    public class PetPortrait extends Sprite {
        ...
        public function PetPortrait(_arg1:int, _arg2:IPetVO, _arg3:Boolean=false, _arg4:Boolean=false, _arg5:Boolean=false, _arg6:Boolean=false){
            this.releaseSignal = new Signal();
            super();
            TweenPlugin.activate([TransformMatrixPlugin]);
            this._petVO = _arg2;
            this._switchable = _arg3;
            this.showReleaseButton = _arg5;
            this.slotWidth = _arg1;
            this.showFeedPower = _arg6;
            ...
            this.contentDividerTitle.y = ((_arg3) ? 110 : 100);
            addChild(this.petFamily);
            this.petFamily.y = ((_arg3) ? 110 : 100);
            this._petSkin = new PetSkinSlot(_arg2, false);
            this._petSkin.x = ((_arg1 / 2) - (40 / 2));
        ...
        public function set petVO(_arg1:IPetVO):void{
            this._petVO = _arg1;
            this.render();
            this._petSkin.skinVO = _arg1;
        }
        ...
        public function set enableAnimation(_arg1:Boolean):void{
            this._petSkin.manualUpdate = _arg1;
            this._enableAnimation = _arg1;
        }
        ...
        private function updateFeedPowerInfo(_arg1:int, _arg2:int, _arg3:Boolean):void{
        }

        public function simulateFeed(_arg1:Array, _arg2:int):void{
            this.updateFeedPowerInfo((this.getCurrentPointsFromAbilitiesList() + _arg2), this.getMaxPointsFromAbilitiesList(), !((_arg2 == 0)));
        }

        private function onReleaseClickHandler(_arg1:MouseEvent):void{
