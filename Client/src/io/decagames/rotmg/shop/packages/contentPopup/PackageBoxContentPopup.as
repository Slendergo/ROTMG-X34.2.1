...
package io.decagames.rotmg.shop.packages.contentPopup{
    ...
    public class PackageBoxContentPopup extends ModalPopup {
        ...
        public function PackageBoxContentPopup(_arg1:PackageInfo){
            this._info = _arg1;
            ...
            this._infoLabel.text = (((_arg1.description)!="") ? _arg1.description : "The package contains all the following items:");
