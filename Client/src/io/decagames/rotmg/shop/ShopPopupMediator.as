...
package io.decagames.rotmg.shop{
    ...
    public class ShopPopupMediator extends Mediator {
        ...
        private function updateMysteryBoxes():void{
            ...
            var _local3:GenericBoxTile;
            this.mysteryBoxesGrid.clearGrid();
            var _local1:Vector.<MysteryBoxInfo> = this.mysteryBoxModel.getBoxesForGrid();
        ...
        private function updateShop(_arg1:TimerEvent):void{
        ...
        private function onPackageClick(_arg1:BaseButton):void{
        ...
        private function onAdd(_arg1:BaseButton):void{
