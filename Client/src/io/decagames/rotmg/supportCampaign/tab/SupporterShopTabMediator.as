...
package io.decagames.rotmg.supportCampaign.tab{
    ...
    public class SupporterShopTabMediator extends Mediator {
        ...
        private function onBannerLoaded(_arg1:Event):void{
        ...
        private function showCampaignView(_arg1:DisplayObject):void{
            this.view.show(this.hudModel.getPlayerName(), this.model.isUnlocked, this.model.isStarted, this.model.unlockPrice, this.model.donatePointsRatio, this.model.isEnded, _arg1);
            this.initView();
        }
        ...
        private function showTier(_arg1:DisplayObject):void{
            this.view.showTier(this.model.nextClaimableTier, this.model.ranks, this.model.rank, this.model.claimed, _arg1);
        }

        private function updateStartCountdown(_arg1:Event):void{
        ...
        private function onPointsUpdate():void{
            ...
            if (_local1.hasSupporterFeature(SupporterFeatures.GLOW)){
        ...
        private function unlockClick(_arg1:BaseButton):void{
        ...
        private function onUnlockComplete(_arg1:Boolean, _arg2):void{
            var xml:XML;
