...
package io.decagames.rotmg.supportCampaign.tab.donate{
    ...
    public class DonatePanel extends Sprite {
        ...
        public function DonatePanel(_arg1:int, _arg2:Boolean){
            this._ratio = _arg1;
            this._isEnded = _arg2;
            this.init();
        }
        ...
        public function addDonateAmount(_arg1:int):void{
        ...
        private function updatePoints(_arg1:int):void{
            this.pointAmountTextfield.text = _arg1.toString();
            var _local2:int = 4;
            var _local3:int = ((this.pointAmountTextfield.width + this.supportIcon.width) + _local2);
