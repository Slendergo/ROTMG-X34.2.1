...
package io.decagames.rotmg.supportCampaign.tab.tiers.preview{
    ...
    public class TiersPreviewMediator extends Mediator {
        ...
        private function onClaimClick(_arg1:BaseButton):void{
        ...
        private function onClaimRequestComplete(_arg1:Boolean, _arg2):void{
            var xml:XML;
        ...
        private function showTier(_arg1:int):void{
            this.disableArrows(true);
            this._currentTierRank = _arg1;
            ...
            if (_local3){
                ...
                this.setArrowState();
                this.view.showTier(_arg1, this.model.rank, this.model.claimed, _local3);
            }
            else {
        ...
        private function onLeftClick(_arg1:BaseButton):void{
            this.displayedTier--;
            this.view.rightArrow.disabled = false;
            this.view.rightArrow.alpha = 1;
            this.setArrowState();
        ...
        private function onRightClick(_arg1:BaseButton):void{
            this.displayedTier++;
            this.view.leftArrow.disabled = false;
            this.view.leftArrow.alpha = 1;
            this.setArrowState();
        ...
        private function disableArrows(_arg1:Boolean):void{
            this.view.leftArrow.disabled = _arg1;
            this.view.leftArrow.alpha = ((_arg1) ? 0.2 : 1);
            this.view.rightArrow.disabled = _arg1;
            this.view.rightArrow.alpha = ((_arg1) ? 0.2 : 1);
        }
