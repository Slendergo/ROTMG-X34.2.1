...
import robotlegs.bender.bundles.mvcs.Mediator;
    ...
    public class FameContentPopupMediator extends Mediator {
        ...
        override public function initialize():void{
            var _local2:DateFormatterReplacement;
            var _local3:Player;
            var _local4:SavedCharacter;
            ...
            if (!this.player.getCharacterById(this.characterID)){
                ...
                _local1 = _local2.format(new Date());
            }
            else {
            ...
            if (this.view.characterId == -1){
                _local3 = this.hudModel.gameSprite.map.player_;
                this.view.setCharacterData(this.totalFame.baseFame, _local3.name_, _local3.level_, ObjectLibrary.typeToDisplayId_[_local3.objectType_], _local1, _local3.getFamePortrait(200));
            }
            else {
        ...
        private function onShowTooltip(_arg1:TextToolTip):void{
        ...
        private function showCompletedDungeons():void{
            var _local2:StatsLine;
            var _local1:Vector.<StatsLine> = new Vector.<StatsLine>();
            this.view.addDungeonLine(new StatsLine("Dungeons", "", "", StatsLine.TYPE_TITLE));
            _local1.push(new DungeonLine("Pirate Cave", "Pirate Cave", (this.metrics.getCharacterStat(this.characterID, MetricsID.PIRATE_CAVES_COMPLETED) + "")));
            _local1.push(new DungeonLine("Undead Lair", "Undead Lair", (this.metrics.getCharacterStat(this.characterID, MetricsID.UNDEAD_LAIRS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Abyss of Demons", "Abyss of Demons", (this.metrics.getCharacterStat(this.characterID, MetricsID.ABYSS_OF_DEMONS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Snake Pit", "Snake Pit", (this.metrics.getCharacterStat(this.characterID, MetricsID.SNAKE_PITS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Spider Den", "Spider Den", (this.metrics.getCharacterStat(this.characterID, MetricsID.SPIDER_DENS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Sprite World", "Sprite World", (this.metrics.getCharacterStat(this.characterID, MetricsID.SPRITE_WORLDS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Tomb of the Ancients", "Tomb of the Ancients", (this.metrics.getCharacterStat(this.characterID, MetricsID.TOMBS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Ocean Trench", "Ocean Trench", (this.metrics.getCharacterStat(this.characterID, MetricsID.TRENCHES_COMPLETED) + "")));
            _local1.push(new DungeonLine("Forbidden Jungle", "Forbidden Jungle", (this.metrics.getCharacterStat(this.characterID, MetricsID.JUNGLES_COMPLETED) + "")));
            _local1.push(new DungeonLine("Manor of the Immortals", "Manor of the Immortals", (this.metrics.getCharacterStat(this.characterID, MetricsID.MANORS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Forest Maze", "Forest Maze", (this.metrics.getCharacterStat(this.characterID, MetricsID.FOREST_MAZE_COMPLETED) + "")));
            _local1.push(new DungeonLine("Lair of Draconis", "Lair of Draconis", ((this.metrics.getCharacterStat(this.characterID, MetricsID.LAIR_OF_DRACONIS_COMPLETED) + this.metrics.getCharacterStat(this.characterID, MetricsID.LAIR_OF_DRACONIS_HM_COMPLETED)) + "")));
            _local1.push(new DungeonLine("Haunted Cemetery", "Haunted Cemetery", (this.metrics.getCharacterStat(this.characterID, MetricsID.HAUNTED_CEMETERY_COMPLETED) + "")));
            _local1.push(new DungeonLine("Cave of a Thousand Treasures", "Cave of A Thousand Treasures", (this.metrics.getCharacterStat(this.characterID, MetricsID.CAVE_OF_A_THOUSAND_TREASURES_COMPLETED) + "")));
            _local1.push(new DungeonLine("Mad Lab", "Mad Lab", (this.metrics.getCharacterStat(this.characterID, MetricsID.MAD_LAB_COMPLETED) + "")));
            _local1.push(new DungeonLine("Davy Jones' Locker", "Davy Jones' Locker", (this.metrics.getCharacterStat(this.characterID, MetricsID.DAVY_JONES_COMPLETED) + "")));
            _local1.push(new DungeonLine("Ice Cave", "Ice Cave", (this.metrics.getCharacterStat(this.characterID, MetricsID.ICE_CAVE_COMPLETED) + "")));
            _local1.push(new DungeonLine("Deadwater Docks", "Deadwater Docks", (this.metrics.getCharacterStat(this.characterID, MetricsID.DEADWATER_DOCKS_COMPLETED) + "")));
            _local1.push(new DungeonLine("The Crawling Depths", "The Crawling Depths", (this.metrics.getCharacterStat(this.characterID, MetricsID.CRAWLING_DEPTH_COMPLETED) + "")));
            _local1.push(new DungeonLine("Woodland Labyrinth", "Woodland Labyrinth", (this.metrics.getCharacterStat(this.characterID, MetricsID.WOODLAND_LAB_COMPLETED) + "")));
            _local1.push(new DungeonLine("Battle for the Nexus", "Battle for the Nexus", (this.metrics.getCharacterStat(this.characterID, MetricsID.BATTLE_NEXUS_COMPLETED) + "")));
            _local1.push(new DungeonLine("The Shatters", "The Shatters", (this.metrics.getCharacterStat(this.characterID, MetricsID.THE_SHATTERS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Belladonna's Garden", "Belladonna's Garden", (this.metrics.getCharacterStat(this.characterID, MetricsID.BELLADONNA_COMPLETED) + "")));
            _local1.push(new DungeonLine("Puppet Master's Theatre", "Puppet Master's Theatre", (this.metrics.getCharacterStat(this.characterID, MetricsID.PUPPET_MASTER_COMPLETED) + "")));
            _local1.push(new DungeonLine("Toxic Sewers", "Toxic Sewers", (this.metrics.getCharacterStat(this.characterID, MetricsID.TOXIC_SEWERS_COMPLETED) + "")));
            _local1.push(new DungeonLine("The Hive", "The Hive", (this.metrics.getCharacterStat(this.characterID, MetricsID.THE_HIVE_COMPLETED) + "")));
            _local1.push(new DungeonLine("Mountain Temple", "Mountain Temple", (this.metrics.getCharacterStat(this.characterID, MetricsID.MOUNTAIN_TEMPLE_COMPLETED) + "")));
            _local1.push(new DungeonLine("The Nest", "The Nest", (this.metrics.getCharacterStat(this.characterID, MetricsID.THE_NEST_COMPLETED) + "")));
            _local1.push(new DungeonLine("Lost Halls", "Lost Halls", (this.metrics.getCharacterStat(this.characterID, MetricsID.LOST_HALLS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Cultist Hideout", "Cultist Hideout", (this.metrics.getCharacterStat(this.characterID, MetricsID.CULTIST_HIDEOUT_COMPLETED) + "")));
            _local1.push(new DungeonLine("The Void", "The Void", (this.metrics.getCharacterStat(this.characterID, MetricsID.THE_VOID_COMPLETED) + "")));
            _local1.push(new DungeonLine("Puppet Master's Encore", "Puppet Master's Encore", (this.metrics.getCharacterStat(this.characterID, MetricsID.PUPPET_ENCORE_COMPLETED) + "")));
            _local1.push(new DungeonLine("Lair of Shaitan", "Lair of Shaitan", (this.metrics.getCharacterStat(this.characterID, MetricsID.LAIR_OF_SHAITAN_COMPLETED) + "")));
            _local1.push(new DungeonLine("Parasite Chambers", "Parasite Chambers", (this.metrics.getCharacterStat(this.characterID, MetricsID.PARASITE_CHAMBERS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Magic Woods", "Magic Woods", (this.metrics.getCharacterStat(this.characterID, MetricsID.MAGIC_WOODS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Cnidarian Reef", "Cnidarian Reef", (this.metrics.getCharacterStat(this.characterID, MetricsID.CNIDARIAN_REEF_COMPLETED) + "")));
            _local1.push(new DungeonLine("Secluded Thicket", "Secluded Thicket", (this.metrics.getCharacterStat(this.characterID, MetricsID.SECLUDED_THICKETS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Cursed Library", "Cursed Library", (this.metrics.getCharacterStat(this.characterID, MetricsID.CURSED_LIBRARIES_COMPLETED) + "")));
            _local1.push(new DungeonLine("Fungal Cavern", "Fungal Cavern", (this.metrics.getCharacterStat(this.characterID, MetricsID.FUNGAL_CAVERNS_COMPLETED) + "")));
            _local1.push(new DungeonLine("Crystal Cavern", "Crystal Cavern", (this.metrics.getCharacterStat(this.characterID, MetricsID.CRYSTAL_CAVERNS_COMPLETED) + "")));
        ...
        private function showStats():void{
            ...
            this.view.addStatLine(new StatsLine("Accuracy", (_local1.toFixed(2) + "%"), "", StatsLine.TYPE_STAT));
        ...
        private function showBonuses():void{
            ...
            var locked:Vector.<FameBonus> = this.bonusesList.filter(function (_arg1:FameBonus, _arg2:int, _arg3:Vector.<FameBonus>):Boolean{
                return ((level < _arg1.level));
            });
