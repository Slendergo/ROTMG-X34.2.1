...
package com.company.assembleegameclient.objects.particles{
    ...
    public class InspireEffect extends ParticleEffect {
        ...
        public function InspireEffect(_arg1:GameObject, _arg2:uint, _arg3:int){
            var _local4:InspireParticle;
            ...
            var _local5:int;
            while (_local5 < _arg3) {
                _local4 = new InspireParticle(_arg2, 100);
        ...
        public function updateSwirl(_arg1:Vector.<InspireParticle>, _arg2:Number, _arg3:Number, _arg4:Number):void{
            var _local5:int;
            var _local6:InspireParticle;
            var _local7:Number;
            var _local8:Number;
            var _local9:Number;
            _local5 = 0;
            while (_local5 < _arg1.length) {
                ...
                _local6.z_ = (((Back.easeOut(_arg4) * 2) - 1) + (_local5 / _arg1.length));
                if (_local6.z_ >= 0){
                    if (_local6.z_ > 1){
                        _local6.alive_ = false;
                    }
                    else {
                        _local7 = (_arg2 * ((((2 * Math.PI) * (_local5 / _arg1.length)) + ((2 * Math.PI) * Back.easeOut(_arg4))) + _arg3));
...
class InspireParticle extends Particle {
    ...
    public function InspireParticle(_arg1:uint, _arg2:int){
        super(_arg1, 0, _arg2);
    }
