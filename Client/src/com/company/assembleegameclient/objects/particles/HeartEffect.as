        ...
        override public function update(_arg1:int, _arg2:int):Boolean{
            ...
            if (!this.bInitialized_){
                ...
                while (_local4 < this.amount_) {
                    _local5 = new HeartParticle(ColorUtil.rangeRandomSmart(this.color_, this.color2_));
                    _local5.cX_ = x_;
                    _local5.cY_ = y_;
                    _local6 = (2 * Math.PI);
                    _local7 = (_local6 / this.amount_);
                    _local5.restart((_arg1 + ((_local7 * _local4) * 1000)), _arg1);
                    _local5.rad_ = this.rad_;
                    this.parts_.push(_local5);
