...
package com.company.assembleegameclient.objects{
    ...
    public class Projectile extends BasicObject {
        ...
        public function reset(_arg1:int, _arg2:int, _arg3:int, _arg4:int, _arg5:Number, _arg6:int, _arg7:String="", _arg8:String="", _arg9:Number=1, _arg10:Number=1):void{
            var _local13:Number;
            clear();
            ...
            this.lifetime_ = (this.projProps_.lifetime_ * _arg9);
            var _local11:String = ((((!((_arg7 == ""))) && ((this.projProps_.objectId_ == _arg8)))) ? _arg7 : this.projProps_.objectId_);
            this.props_ = ObjectLibrary.getPropsFromId(_local11);
            hasShadow_ = (this.props_.shadowSize_ > 0);
            var _local12:TextureData = ObjectLibrary.typeToTextureData_[this.props_.type_];
            this.texture_ = _local12.getTexture(objectId_);
            ...
            if (this.projProps_.size_ >= 0){
                _local13 = this.projProps_.size_;
            }
            else {
                _local13 = ObjectLibrary.getSizeFromType(this.containerType_);
            }
            this.p_.setSize((8 * (_local13 / 100)));
            this.damage_ = 0;
        }
        ...
        private function positionAt(_arg1:int, _arg2:Point):void{
            ...
            var _local3:Number = ((_arg1 * (this.projProps_.speed_ / 10000)) * this.speedMul_);
            ...
            if (this.projProps_.wavy_){
                ...
                if (this.projProps_.parametric_){
                    _local8 = (((_arg1 / this.lifetime_) * 2) * Math.PI);
                    ...
                    if (this.projProps_.boomerang_){
                        _local13 = ((this.lifetime_ * ((this.projProps_.speed_ * this.speedMul_) / 10000)) / 2);
                        if (_local3 > _local13){
                    ...
                    if (this.projProps_.amplitude_ != 0){
                        _local14 = (this.projProps_.amplitude_ * Math.sin((_local4 + ((((_arg1 / this.lifetime_) * this.projProps_.frequency_) * 2) * Math.PI))));
            ...
            if (_local6 != null){
                ...
                if (_local10){
                    ...
                    if (_local6 == _local7){
                        ...
                        _local6.damage(true, _local11, this.projProps_.effects_, false, this);
                    }
                    else {
                        if (_local6.props_.isEnemy_){
                            map_.gs_.gsc_.enemyHit(_arg1, this.bulletId_, _local6.objectId_, _local12);
                            _local6.damage(true, _local11, this.projProps_.effects_, _local12, this);
                        }
                        else {
        ...
        override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void{
            ...
            if (Parameters.projColorType_ != 0){
                ...
                _local4 = TextureRedrawer.redraw(_local4, 120, true, _local9);
            }
            ...
            var _local6:Number = ((this.projProps_.faceDir_) ? this.getDirectionAngle(_arg3) : this.angle_);
            var _local7:Number = ((this.projProps_.noRotation_) ? (_arg2.angleRad_ + this.props_.angleCorrection_) : (((_local6 - _arg2.angleRad_) + this.props_.angleCorrection_) + _local5));
            this.p_.draw(_arg1, this.staticVector3D_, _local7, _arg2.wToS_, _arg2, _local4);
            if (((!(Parameters.data_.noParticlesMaster)) && (this.projProps_.particleTrail_))){
                _local10 = (((this.projProps_.particleTrailLifetimeMS)!=-1) ? this.projProps_.particleTrailLifetimeMS : 600);
                _local11 = 0;
                for (;_local11 < 3;_local11++) {
                    ...
                    map_.addObj(new SparkParticle(100, this.projProps_.particleTrailColor_, _local10, 0.5, RandomUtil.plusMinus(3), RandomUtil.plusMinus(3)), x_, y_);
                }
            }
        }

        private function getDirectionAngle(_arg1:Number):Number{
            var _local2:int = (_arg1 - this.startTime_);
