...
package com.company.assembleegameclient.objects{
    ...
    public class Character extends GameObject {
        ...
        override public function damage(_arg1:Boolean, _arg2:int, _arg3:Vector.<uint>, _arg4:Boolean, _arg5:Projectile, _arg6:Boolean=false):void{
            super.damage(_arg1, _arg2, _arg3, _arg4, _arg5, _arg6);
            if (dead_){
