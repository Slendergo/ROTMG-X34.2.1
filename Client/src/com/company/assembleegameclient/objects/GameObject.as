...
package com.company.assembleegameclient.objects{
    ...
    public class GameObject extends BasicObject {
        ...
        public function setTexture(_arg1:int):void{
            var _local2:TextureData = ObjectLibrary.typeToTextureData_[_arg1];
            this.texture_ = _local2.texture_;
            this.mask_ = _local2.mask_;
            this.animatedChar_ = _local2.animatedChar_;
        }
        ...
        public function damage(_arg1:Boolean, _arg2:int, _arg3:Vector.<uint>, _arg4:Boolean, _arg5:Projectile, _arg6:Boolean=false):void{
            var _local8:int;
            var _local9:uint;
            ...
            if (((!(((this.props_.isEnemy_) && (Parameters.data_.disableEnemyParticles)))) && (!(((!(this.props_.isEnemy_)) && (Parameters.data_.disablePlayersHitParticles)))))){
                ...
                if (this.dead_){
                    map_.addObj(new ExplosionEffect(_local15, this.size_, 30), x_, y_);
                }
                else {
                    if (_arg5 != null){
                        map_.addObj(new HitEffect(_local15, this.size_, 10, _arg5.angle_, _arg5.projProps_.speed_), x_, y_);
                    }
                    else {
        ...
        protected function drawHpBar(_arg1:Vector.<IGraphicsData>, _arg2:int=6):void{
            ...
            if (this.hp_ > 0){
                ...
                this.hpbarFill_.color = (((_local6 < 0.5)) ? (((_local6 < 0.2)) ? 14684176 : 16744464) : 0x10FF00);
        ...
        override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void{
            ...
            if (this.statusFlash_ != null){
                if (!this.statusFlash_.doneAt(_arg3)){
                    if (Parameters.isGpuRender()){
                        this.statusFlash_.applyGPUTextureColorTransform(_local4, _arg3);
                    }
                    else {
        ...
        public function drawConditionIcons(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void{
            ...
            while (_local8 < _local7) {
                ...
                (_local11.data as Vector.<Number>).push(_local12, _local13, (_local12 + _local9.width), _local13, (_local12 + _local9.width), (_local13 + _local9.height), _local12, (_local13 + _local9.height));
        ...
        override public function drawShadow(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void{
            ...
            (this.shadowPath_.data as Vector.<Number>).push((posS_[0] - _local5), (posS_[1] - _local6), (posS_[0] + _local5), (posS_[1] - _local6), (posS_[0] + _local5), (posS_[1] + _local6), (posS_[0] - _local5), (posS_[1] + _local6));
