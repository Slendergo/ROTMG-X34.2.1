...
package com.company.assembleegameclient.objects{
    ...
    public class ObjectLibrary {
        ...
        public static function parseDungeonXML(_arg1:String, _arg2:XML):void{
            ...
            if ((((_arg1.indexOf("_ObjectsCXML") == -1)) && ((_arg1.indexOf("_StaticObjectsCXML") == -1)))){
                if (_arg1.indexOf("Objects") != -1){
                    _local4 = _arg1.indexOf("ObjectsCXML");
                }
                else {
        ...
        public static function getSetXMLFromType(_arg1:int):XML{
            var _local2:XML;
            var _local3:int;
        ...
        public static function isDropTradable(_arg1:int):Boolean{
            var _local2:XML = xmlLibrary_[_arg1];
            return (((!((_local2 == null))) && (_local2.hasOwnProperty("DropTradable"))));
        }
