...
package com.company.assembleegameclient.game{
    ...
    public class MapUserInput {
        ...
        public function MapUserInput(_arg1:GameSprite){
            ...
            this.toggleRealmQuestsDisplaySignal = _local2.getInstance(ToggleRealmQuestsDisplaySignal);
            ...
            this.closePopupByClassSignal = _local2.getInstance(ClosePopupByClassSignal);
        ...
        public function onMouseDown(_arg1:MouseEvent):void{
            ...
            if (_arg1.shiftKey){
                ...
                if (Parameters.isGpuRender()){
                    if ((((((((_arg1.currentTarget == _arg1.target)) || ((_arg1.target == this.gs_.map)))) || ((_arg1.target == this.gs_)))) || ((_arg1.target == this.gs_.map.mapHitArea)))){
            ...
            if (Parameters.isGpuRender()){
                if ((((((((((_arg1.currentTarget == _arg1.target)) || ((_arg1.target == this.gs_.map)))) || ((_arg1.target == this.gs_)))) || ((_arg1.currentTarget == this.gs_.chatBox_.list)))) || ((_arg1.target == this.gs_.map.mapHitArea)))){
            ...
            if (_local2.isUnstable()){
                _local2.attemptAttackAngle(((Math.random() * Math.PI) * 2));
            }
            else {
        ...
        private function onKeyDown(_arg1:KeyboardEvent):void{
            var _local4:CloseAllPopupsSignal;
            var _local5:AddTextLineSignal;
            var _local6:ChatMessage;
            var _local7:GameObject;
            var _local8:Number;
            var _local9:Number;
            var _local10:Boolean;
            var _local11:ShowPopupSignal;
            var _local12:OpenDialogSignal;
            var _local13:Square;
            var _local2:Stage = this.gs_.stage;
            ...
            if (this.currentString == UIUtils.EXPERIMENTAL_MENU_PASSWORD.slice(0, this.currentString.length)){
                if (this.currentString.length == UIUtils.EXPERIMENTAL_MENU_PASSWORD.length){
                    _local5 = StaticInjectorContext.getInjector().getInstance(AddTextLineSignal);
                    _local6 = new ChatMessage();
                    _local6.name = Parameters.SERVER_CHAT_NAME;
                    this.currentString = "";
                    UIUtils.SHOW_EXPERIMENTAL_MENU = !(UIUtils.SHOW_EXPERIMENTAL_MENU);
                    _local6.text = ((UIUtils.SHOW_EXPERIMENTAL_MENU) ? "Experimental menu activated" : "Experimental menu deactivated");
                    _local5.dispatch(_local6);
                };
            }
            else {
                this.currentString = "";
            ...
            switch (_arg1.keyCode){
                ...
                case Parameters.data_.useSpecial:
                    ...
                    if (_local7 == null) break;
                    if (!this.specialKeyDown_){
                        if (_local3.isUnstable()){
                            _local8 = ((Math.random() * 600) - 300);
                            _local9 = ((Math.random() * 600) - 325);
                        }
                        else {
                            _local8 = this.gs_.map.mouseX;
                            _local9 = this.gs_.map.mouseY;
                        };
                        _local10 = _local3.useAltWeapon(_local8, _local9, UseType.START_USE);
                        if (_local10){
                ...
                case Parameters.data_.escapeToNexus2:
                    _local4 = StaticInjectorContext.getInjector().getInstance(CloseAllPopupsSignal);
                    _local4.dispatch();
                ...
                case Parameters.data_.friendList:
                    ...
                    if (this.isFriendsListOpen){
                        if (Parameters.USE_NEW_FRIENDS_UI){
                            _local11 = StaticInjectorContext.getInjector().getInstance(ShowPopupSignal);
                            _local11.dispatch(new SocialPopupView());
                        }
                        else {
                            _local12 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
                            _local12.dispatch(new FriendListView());
                        };
                    }
                    else {
            ...
            if (this.areFKeysAvailable){
                switch (_arg1.keyCode){
                    case KeyCodes.F6:
                        ...
                        break;
                    case KeyCodes.F7:
                        for each (_local13 in this.gs_.map.squares_) {
                            if (_local13 != null){
                                _local13.faces_.length = 0;
                            };
                        };
        ...
        private function useItem(_arg1:int):void{
            ...
            var _local2:Player = this.gs_.map.player_;
            var _local3:int = _local2.equipment_[_arg1];
            var _local4:int = ObjectLibrary.getMatchingSlotIndex(_local3, _local2);
            if (_local4 != -1){
                if (!this.swapTooSoon()){
                    GameServerConnection.instance.invSwap(_local2, _local2, _arg1, _local3, _local2, _local4, _local2.equipment_[_local4]);
                };
            }
            else {
                GameServerConnection.instance.useItem_new(_local2, _arg1);
            };
        }
