...
package com.company.assembleegameclient.screens{
    ...
    public class ScoringBox extends Sprite {
        ...
        public function ScoringBox(_arg1:Rectangle, _arg2:XML){
            ...
            this.addLine(TextKey.FAMEVIEW_DUNGEONSCOMPLETED, null, 0, (((((((((((((((((((((((((((((((((((((int(_arg2.PirateCavesCompleted) + int(_arg2.UndeadLairsCompleted)) + int(_arg2.AbyssOfDemonsCompleted)) + int(_arg2.SnakePitsCompleted)) + int(_arg2.SpiderDensCompleted)) + int(_arg2.SpriteWorldsCompleted)) + int(_arg2.TombsCompleted)) + int(_arg2.TrenchesCompleted)) + int(_arg2.JunglesCompleted)) + int(_arg2.ManorsCompleted)) + int(_arg2.ForestMazeCompleted)) + int(_arg2.LairOfDraconisCompleted)) + int(_arg2.CandyLandCompleted)) + int(_arg2.HauntedCemeteryCompleted)) + int(_arg2.CaveOfAThousandTreasuresCompleted)) + int(_arg2.MadLabCompleted)) + int(_arg2.DavyJonesCompleted)) + int(_arg2.TombHeroicCompleted)) + int(_arg2.DreamscapeCompleted)) + int(_arg2.IceCaveCompleted)) + int(_arg2.DeadWaterDocksCompleted)) + int(_arg2.CrawlingDepthCompleted)) + int(_arg2.WoodLandCompleted)) + int(_arg2.BattleNexusCompleted)) + int(_arg2.TheShattersCompleted)) + int(_arg2.BelladonnaCompleted)) + int(_arg2.PuppetMasterCompleted)) + int(_arg2.ToxicSewersCompleted)) + int(_arg2.TheHiveCompleted)) + int(_arg2.MountainTempleCompleted)) + int(_arg2.TheNestCompleted)) + int(_arg2.LairOfDraconisHmCompleted)) + int(_arg2.LostHallsCompleted)) + int(_arg2.CultistHideoutCompleted)) + int(_arg2.TheVoidCompleted)) + int(_arg2.PuppetEncoreCompleted)) + int(_arg2.LairOfShaitanCompleted)) + int(_arg2.ParasiteChambersCompleted)), false, 5746018);
