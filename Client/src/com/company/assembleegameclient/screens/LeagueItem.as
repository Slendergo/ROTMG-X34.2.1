...
package com.company.assembleegameclient.screens{
    ...
    public class LeagueItem extends Sprite {
        ...
        public function LeagueItem(_arg1:LeagueData){
            this._leagueData = _arg1;
            this.init();
        }

        public function characterDance(_arg1:Boolean):void{
            if (_arg1){
        ...
        public function updateTimeLabel(_arg1:Number):void{
            var _local2:TimeSpan = new TimeSpan(_arg1);
            var _local3 = "Season will end in: ";
