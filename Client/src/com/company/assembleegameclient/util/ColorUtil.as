...
package com.company.assembleegameclient.util{
    public class ColorUtil {
        ...
        public static function randomSmart(_arg1:uint):Number{
            ...
            var _local5:uint = Math.max(0, Math.min(0xFF, (_local2 + RandomUtil.plusMinus((_local2 * 0.05)))));
            var _local6:uint = Math.max(0, Math.min(0xFF, (_local3 + RandomUtil.plusMinus((_local3 * 0.05)))));
            var _local7:uint = Math.max(0, Math.min(0xFF, (_local4 + RandomUtil.plusMinus((_local4 * 0.05)))));
