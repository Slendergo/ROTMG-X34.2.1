...
package com.company.assembleegameclient.util{
    ...
    public class TextureRedrawer {
        ...
        public static function redraw(_arg1:BitmapData, _arg2:int, _arg3:Boolean, _arg4:uint, _arg5:Boolean=true, _arg6:Number=5, _arg7:int=0, _arg8:Number=1.4):BitmapData{
            var _local9:String = getHash(_arg2, _arg3, _arg4, _arg6, _arg7);
            if (((_arg5) && (isCached(_arg1, _local9)))){
                return (redrawCaches[_arg1][_local9]);
            }
            var _local10:BitmapData = resize(_arg1, null, _arg2, _arg3, 0, 0, _arg6);
            _local10 = GlowRedrawer.outlineGlow(_local10, _arg4, _arg8, _arg5, _arg7);
            if (_arg5){
                cache(_arg1, _local9, _local10);
            }
            return (_local10);
        }

        private static function getHash(_arg1:int, _arg2:Boolean, _arg3:uint, _arg4:Number, _arg5:int):String{
            return (((((((((_arg1.toString() + ",") + _arg3.toString()) + ",") + _arg2) + ",") + _arg4) + ",") + _arg5));
        }
        ...
        private static function retexture(_arg1:BitmapData, _arg2:BitmapData, _arg3:int, _arg4:int):BitmapData{
            ...
            var _local7:BitmapData = getTexture((((_arg3 >= 0)) ? _arg3 : 0), colorTexture1);
            var _local8:BitmapData = getTexture((((_arg4 >= 0)) ? _arg4 : 0), colorTexture2);
