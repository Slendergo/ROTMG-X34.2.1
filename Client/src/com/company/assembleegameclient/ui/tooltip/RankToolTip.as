...
package com.company.assembleegameclient.ui.tooltip{
    ...
    public class RankToolTip extends ToolTip {
        ...
        public function RankToolTip(_arg1:int){
            ...
            this.howToText_.setStringBuilder(new LineBuilder().setParams((((_arg1 >= FameUtil.MAX_STARS)) ? TextKey.RANK_TOOL_TIP_COMPLETED_ALL_CLASS_QUESTS : TextKey.RANK_TOOL_TIP_COMPLETING_CLASS_QUESTS)));
