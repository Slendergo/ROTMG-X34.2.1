    ...
    public class Options extends Sprite {
        ...
        public function Options(_arg1:GameSprite){
            ...
            if (UIUtils.SHOW_EXPERIMENTAL_MENU){
                ...
                _local6 = TABS.indexOf("Experimental");
                if (_local6 != -1){
                    TABS.pop();
                };
            };
            ...
            while (_local4 < TABS.length) {
                _local7 = new OptionsTabTitle(TABS[_local4]);
                _local7.x = _local3;
                _local7.y = 70;
                addChild(_local7);
                _local7.addEventListener(MouseEvent.CLICK, this.onTabClick);
                this.tabs_.push(_local7);
        ...
        private function createScrollWindow():void{
            ...
            _local1.graphics.drawRect(0, SCROLL_Y_OFFSET, 800, SCROLL_HEIGHT);
            addChild(_local1);
        ...
        private function addOptionAndPosition(_arg1:Option, _arg2:Number=0, _arg3:Number=0):void{
            var positionOption:Function;
            var option:Option = _arg1;
        ...
        private function addOption(_arg1:Option):void{
            this.scrollContainer.addChild(_arg1);
