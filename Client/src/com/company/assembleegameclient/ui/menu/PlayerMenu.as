...
package com.company.assembleegameclient.ui.menu{
    ...
    public class PlayerMenu extends Menu {
        ...
        public function initDifferentServer(_arg1:AGameSprite, _arg2:String, _arg3:Boolean=false, _arg4:Boolean=false):void{
            ...
            addOption(_local5);
            _local5 = new MenuOption(AssetLibrary.getImageFromSet("lofiInterfaceBig", 8), 0xFFFFFF, TextKey.FRIEND_BLOCK_BUTTON);
            _local5.addEventListener(MouseEvent.CLICK, this.onIgnoreDifferentServer);
            addOption(_local5);
        ...
        private function onIgnoreDifferentServer(_arg1:Event):void{
        ...
        private function onAddFriend(_arg1:Event):void{
            ...
            _local2.dispatch(new FriendRequestVO(FriendsActions.INVITE, this.playerName_));
            remove();
        }
