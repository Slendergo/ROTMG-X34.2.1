...
package com.company.assembleegameclient.mapeditor{
    ...
    public class EditingScreen extends Sprite {
        ...
        private function init():void{
            ...
            var _local1:PlayerModel = this.injector.getInstance(PlayerModel);
            this.isPlayerAdmin = _local1.isAdmin();
        ...
        private function createChooserDropDown():void{
            var _local1:Vector.<String>;
            if (this.isPlayerAdmin){
                this.chooserDropDown_ = new DropDown(GroupDivider.GROUP_LABELS, Chooser.WIDTH, 26);
            }
            else {
                _local1 = GroupDivider.GROUP_LABELS.concat();
                _local1.splice(_local1.indexOf(AllObjectChooser.GROUP_NAME_GAME_OBJECTS), 1);
                this.chooserDropDown_ = new DropDown(_local1, Chooser.WIDTH, 26);
            };
        ...
        private function createCheckboxes():void{
            this.checkBoxArray = [];
            var _local1:DeprecatedClickableText = new DeprecatedClickableText(14, true, "(Show All)");
            ...
            addChild(_local1);
            var _local2:CheckBoxField = new CheckBoxField("Objects", true);
            ...
            addChild(_local2);
            var _local3:DeprecatedClickableText = new DeprecatedClickableText(14, true, "(Hide All)");
        ...
        private function createChoosers():void{
            ...
            var _local1:int = ((MAP_Y + this.mapSizeDropDown_.height) + 50);
            this.groundChooser_ = new GroundChooser();
            this.groundChooser_.x = this.chooserDropDown_.x;
            this.groundChooser_.y = _local1;
            ...
            this.object3DChooser_.y = _local1;
            ...
            this.dungeonChooser_.y = _local1;
            ...
            if (this.isPlayerAdmin){
                ...
                this.allGameObjChooser_.y = _local1;
        ...
        private function onFileBrowseSelect(_arg1:Event):void{
