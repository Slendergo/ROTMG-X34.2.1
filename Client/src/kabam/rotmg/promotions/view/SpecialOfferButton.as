...
package kabam.rotmg.promotions.view{
    ...
    public class SpecialOfferButton extends BasePackageButton {
        ...
        public function SpecialOfferButton(_arg1:Boolean){
            this._isPackageOffer = _arg1;
            this.init();
        }
        ...
        public function set isSpecialOfferAvailable(_arg1:Boolean):void{
            this._isSpecialOfferAvailable = _arg1;
        }
