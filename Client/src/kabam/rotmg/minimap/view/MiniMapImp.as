...
package kabam.rotmg.minimap.view{
    ...
    public class MiniMapImp extends MiniMap {
        ...
        override public function draw():void{
            ...
            var _local9:Number = (mouseX - (this._width / 2));
            var _local10:Number = (mouseY - (this._height / 2));
            this.players_.length = 0;
            for each (_local11 in map.goDict_) {
                if (!((_local11.props_.noMiniMap_) || ((_local11 == this.focus)))){
                    _local17 = (_local11 as Player);
                    if (_local17 != null){
                        if (_local17.isPaused()){
                            _local16 = 0x7F7F7F;
                        }
                        else {
                            if (((((Parameters.data_.newMiniMapColors) && (_local17.isFellowGuild_))) && (!(_local17.starred_)))){
                                _local16 = 0xCF00;
                            }
                            else {
                                if (_local17.isFellowGuild_){
                                    _local16 = 0xFF00;
                                }
                                else {
                                    if (((((Parameters.data_.newMiniMapColors) && (!(_local17.nameChosen_)))) && (_local17.starred_))){
                                        _local16 = 0xFFFFFF;
                                    }
                                    else {
                                        if (((Parameters.data_.newMiniMapColors) && (!(_local17.nameChosen_)))){
                                            _local16 = 0xCFCFCF;
                                        }
                                        else {
                                            if (((Parameters.data_.newMiniMapColors) && (!(_local17.starred_)))){
                                                _local16 = 0xCFCF00;
                                            }
                                            else {
                                                _local16 = 0xFFFF00;
                        ...
                        if ((_local11 is Character)){
                            if (_local11.props_.isEnemy_){
                                if (_local11.props_.color_ != -1){
                                    _local16 = _local11.props_.color_;
                                }
                                else {
                                    _local16 = 0xFF0000;
                                };
            ...
            var _local15:Number = (((this.mapMatrix_.b * _local12) + (this.mapMatrix_.d * _local13)) + this.mapMatrix_.ty);
