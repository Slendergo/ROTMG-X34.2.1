...
package kabam.rotmg.game.view{
    ...
    public class ShopDisplay extends Sprite {
        ...
        public function ShopDisplay(_arg1:Boolean){
            this._isOnNexus = _arg1;
            ...
            var _local3:int = 10;
            this.text.x = (_local2.right - _local3);
            this.text.y = ((_local2.bottom - _local3) - 3);
        ...
        public function newIndicator(_arg1:Boolean):void{
            if (_arg1){
                this.addIndicator();
            }
            else {
        ...
        public function onShopClick(_arg1:MouseEvent):void{
            if (this._isOnNexus){
                this.openShop();
