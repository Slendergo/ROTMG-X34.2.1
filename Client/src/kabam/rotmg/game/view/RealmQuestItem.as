...
package kabam.rotmg.game.view{
    ...
    public class RealmQuestItem extends Sprite {
        ...
        public function RealmQuestItem(_arg1:String, _arg2:Boolean){
            this._description = _arg1;
            this._isComplete = _arg2;
            this.init();
        }

        public function updateItemState(_arg1:Boolean):void{
            this._isComplete = _arg1;
            this.createDiamond();
        }

        public function updateItemText(_arg1:String):void{
            this._description = _arg1;
        ...
        private function createLabel():void{
            var _local1:TextFormat = DefaultLabelFormat.createTextFormat(12, 0xFFFFFF, TextFormatAlign.LEFT, false);
