...
package kabam.rotmg.game.view.components{
    ...
    public class StatsView extends Sprite {
        ...
        private function drawStats(_arg1:Player):void{
            this.stats_[ATTACK].draw(_arg1.attack_, _arg1.attackBoost_, _arg1.attackMax_, _arg1.level_);
            this.stats_[DEFENSE].draw(_arg1.defense_, _arg1.defenseBoost_, _arg1.defenseMax_, _arg1.level_);
            this.stats_[SPEED].draw(_arg1.speed_, _arg1.speedBoost_, _arg1.speedMax_, _arg1.level_);
            this.stats_[DEXTERITY].draw(_arg1.dexterity_, _arg1.dexterityBoost_, _arg1.dexterityMax_, _arg1.level_);
            this.stats_[VITALITY].draw(_arg1.vitality_, _arg1.vitalityBoost_, _arg1.vitalityMax_, _arg1.level_);
            this.stats_[WISDOM].draw(_arg1.wisdom_, _arg1.wisdomBoost_, _arg1.wisdomMax_, _arg1.level_);
        }
