...
package kabam.rotmg.game.view{
    ...
    public class SellableObjectPanel extends Panel implements TooltipAble {
        ...
        private static function createRankReqText(_arg1:int):Sprite{
        ...
        private function onRemovedFromStage(_arg1:Event):void{
            var _local2:Injector;
            var _local3:ClosePopupByClassSignal;
        ...
        private function buyEvent():void{
            ...
            if (((((!((parent == null))) && (_local1.isRegistered()))) && ((this.owner_ is Merchant)))){
                _local2 = StaticInjectorContext.getInjector();
                _local3 = _local2.getInstance(ShowPopupSignal);
                _local3.dispatch(new NexusShopPopupView(this.buyItem, this.owner_, this.buyButton_.width, this.availableInventoryNumber));
            }
            else {
