...
package kabam.rotmg.dailyLogin.view{
    ...
    public class DailyLoginModal extends Sprite {
        ...
        public function showLegend(_arg1:Boolean):void{
            ...
            var _local7:BitmapData = AssetLibrary.getImageFromSet("lofiInterfaceBig", 11);
            _local7 = TextureRedrawer.redraw(_local7, 20, true, 0);
            _local8 = new Bitmap(_local7);
            _local8.x = (-(Math.round((_local8.width / 2))) + 10);
            _local8.y = (-(Math.round((_local8.height / 2))) + 30);
